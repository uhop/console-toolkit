...
export const drawRow = (data, width, maxValue, {zeroLimit = 0.5, initState = {}}) => {
...
export const drawChart = (values, width, {maxValue, theme = defaultTheme, zeroLimit = 0.5, initState = {}} = {}) => {
  ...
  return data.map(row => drawRow(row, width, max, {zeroLimit, initState}));
};
