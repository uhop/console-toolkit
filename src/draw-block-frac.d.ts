 ...
 * @param drawEmptyBorder - If true, draw an empty border column when fractional part is 0.
 ...
 * @param drawEmptyBorder - If true, draw an empty border row when fractional part is 0.
 * @returns A Box containing the drawn block.
 */
