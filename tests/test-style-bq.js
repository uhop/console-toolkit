...
test('Styling with back quotes', async t => {
  await t.test('Plain styling', t => {
    ...
    t.equal(text, 'Hello, \x1B[22;1;31mbold red\x1B[39m bold\x1B[22m!');
  });
  ...
  await t.test('Plain styling with c vs. s', t => {
    ...
    t.equal(textS, 'Hello, \x1B[22;1;31mbold red\x1B[39m bold!');
    const textC = c`Hello, {{bold.red}}bold red{{defaultColor}} bold!`;
    t.equal(textC, 'Hello, \x1B[22;1;31mbold red\x1B[39m bold!\x1B[22m');
  });
  ...
  await t.test('Canned style', t => {
    ...
    t.equal(textS, '\x1B[22;1;31mHello, bold red!');
    const textC = warnC`Hello, bold red!`;
    t.equal(textC, '\x1B[22;1;31mHello, bold red!\x1B[22;39m');

    const textC2 = warnC`Hi!`;
    t.equal(textC2, '\x1B[22;1;31mHi!\x1B[22;39m');
