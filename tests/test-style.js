...
test('Styling', t => {
  ...
  t.test('List of bright colors', t => {
    const s =
      style.brightBlack +
      style.brightRed +
      style.brightGreen +
  ...
  t.test('List of background colors', t => {
    const s =
      style.bgBlack +
      style.bgRed +
      style.bgGreen +
  ...
  t.test('List of bright background colors', t => {
    const s =
      style.bgBrightBlack +
      style.bgBrightRed +
      style.bgBrightGreen +
  ...
  t.test('List of dark background colors', t => {
    const s =
      style.bgDarkBlack +
      style.bgDarkRed +
      style.bgDarkGreen +
  ...
  t.test('Check different ways to specify a named color', t => {
  ...
  t.test('Condense commands into a state', t => {
