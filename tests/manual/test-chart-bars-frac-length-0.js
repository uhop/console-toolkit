import drawChart from '../../src/charts/bars/frac-grouped.js';
...
console.log('Grouped bars with real size:');
draw(drawChart([[5.1, 5.2, 5.3, 5.4, 5.5, 11.6, 11.7, 11.8, 11.9, 3, 12]], 50, {theme: customTheme}));
