...
show(c(null)`Hello, {{save.bold.save.bright.cyan}}bold bright cyan{{restore}} bold{{restore}}! We love you!`);
show(c`Hello, {{save.bold.save.bright.cyan}}bold bright cyan bold! We love you!`);
show(c(null)`Hello, {{save.bold.save.bright.cyan}}bold bright cyan bold! We love you!`);
